exports.tweetStack = [
   ...
   "I am glad you survived long enough to read this, sending you endless love & light", 
   ...
   "Every green, growing thing you pass today is an ode to you",
   ...
   "Think about how many songs people hear and immediately think of their time with you",
   ...
   "Some of the people who will mean the most to you, you probably haven't even met yet & that's so exciting",
   ...
   "Hiiii, just stopping by to say you are amazing!!!", 
   "Hi, hello, just popping by to say you are so incredibly loved",
   "Anyone who has tried to limit you by telling you what you are and are not capable of is wrong",
   ...
   "Think about a time your laugh was infectious & spread throughout a whole room. Carry that joy with you today!!",
   ...
   "It's okay to take space to honor and celebrate the work you've done",
   ...
   "You are loved on the good days & you are loved on the bad ones",
   ...
   "There are so many ways to fill your life with love & all of them begin & end with you", 
   ...
   "Every time you wake up you are entering into a future made better by your existance!!", 
   ...
   "It's amazing to want to improve yourself, but alsoooo you already have all you need to be the best possible version of yourself today!",
   ...
   "That our paths cross at all is a miracle",
...
console.log(exports.tweetStack.length);